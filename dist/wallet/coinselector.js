...
class CoinSelector {
    ...
    async attemptSelection() {
        ...
        const changeSpendingSize = await changeOutputCoin.estimateSpendingSize(this.getAccount);
        const costOfSpendingChange = changeSpendingSize * CoinSelector.LONG_TERM_FEERATE;
...
//# sourceMappingURL=coinselector.js.map