 ...
 * @extends Node
 */
var WalletNode = /** @class */ (function (_super) {
    __extends(WalletNode, _super);
    /**
    ...
    function WalletNode(options) {
        var _this = _super.call(this, 'bcoin', 'wallet.conf', 'wallet.log', options) || this;
        _this.opened = false;
        _this.client = new Client({
            network: _this.network,
            url: _this.config.str('node-url'),
            host: _this.config.str('node-host'),
            port: _this.config.uint('node-port', _this.network.rpcPort),
            ssl: _this.config.bool('node-ssl'),
            apiKey: _this.config.str('node-api-key')
        });
     ...
     * @private
     */
    WalletNode.prototype.init = function () {
        var _this = this;
        this.wdb.on('error', function (err) { return _this.error(err); });
     ...
     * @returns {Promise}
     */
    WalletNode.prototype.open = function () {
     ...
     * @returns {Promise}
     */
    WalletNode.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
