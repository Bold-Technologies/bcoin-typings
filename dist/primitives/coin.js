...
class Coin extends Output {
    ...
    fromOptions(options) {
        ...
        if (options.value != null) {
            assert(Number.isSafeInteger(options.value) && options.value >= 0, 'Value must be a safe integer.');
    ...
    fromJSON(json) {
        ...
        assert(Number.isSafeInteger(json.value) && json.value >= 0, 'Value must be a safe integer.');
