...
var Input = /** @class */ (function () {
     ...
     * @param {Object} options
     */
    Input.prototype.fromOptions = function (options) {
     ...
     * @returns {Input}
     */
    Input.fromOptions = function (options) {
     ...
     * @returns {Boolean}
     */
    Input.prototype.equals = function (input) {
     ...
     */
    Input.prototype.getType = function (coin) {
        if (this.isCoinbase())
            return 'coinbase';
        if (coin)
            return coin.getType();
     ...
     */
    Input.prototype.getRedeem = function (coin) {
        if (this.isCoinbase())
            return null;
        if (!coin) {
     ...
     */
    Input.prototype.getSubtype = function (coin) {
        if (this.isCoinbase())
            return null;
     ...
     */
    Input.prototype.getAddress = function (coin) {
        if (this.isCoinbase())
            return null;
        if (coin)
     ...
     * @returns {Hash} hash
     */
    Input.prototype.getHash = function (coin, enc) {
     ...
     * @returns {Boolean}
     */
    Input.prototype.isRBF = function () {
     ...
     * @returns {Boolean}
     */
    Input.prototype.isCoinbase = function () {
     ...
     * @returns {Object}
     */
    Input.prototype[inspectSymbol] = function () {
        return this.format();
    };
    /**
     * Convert the input to a more user-friendly object.
     ...
     * @returns {Object}
     */
    Input.prototype.format = function (coin) {
        return {
     ...
     * @returns {Object}
     */
    Input.prototype.toJSON = function (network, coin) {
        return this.getJSON();
    };
    /**
     * Convert the input to an object suitable
     ...
     * @returns {Object}
     */
    Input.prototype.getJSON = function (network, coin) {
     ...
     */
    Input.prototype.toRaw = function () {
     ...
     */
    Input.prototype.toWriter = function (bw) {
     ...
     */
    Input.prototype.fromReader = function (br) {
     ...
     * @param {Buffer} data
     */
    Input.prototype.fromRaw = function (data) {
     ...
     * @returns {Input}
     */
    Input.fromRaw = function (data, enc) {
     ...
     */
    Input.prototype.fromOutpoint = function (outpoint) {
     ...
     * @returns {Input}
     */
    Input.fromOutpoint = function (outpoint) {
     ...
     * @param {Coin} coin
     */
    Input.prototype.fromCoin = function (coin) {
     ...
     * @param {Number} index
     */
    Input.prototype.fromTX = function (tx, index) {
        assert(tx);
     ...
     * @returns {Input}
     */
    Input.fromTX = function (tx, index) {
