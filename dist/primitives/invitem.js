...
var InvItem = /** @class */ (function () {
     ...
     */
    InvItem.prototype.getSize = function () {
        return 36;
    };
    /**
     * Write inv item to buffer writer.
     * @param {BufferWriter} bw
     */
    InvItem.prototype.toWriter = function (bw) {
     ...
     * @returns {Buffer}
     */
    InvItem.prototype.toRaw = function () {
     ...
     */
    InvItem.prototype.fromReader = function (br) {
     ...
     * @param {Buffer} data
     */
    InvItem.prototype.fromRaw = function (data) {
     ...
     * @returns {InvItem}
     */
    InvItem.fromReader = function (br) {
     ...
     * @returns {InvItem}
     */
    InvItem.fromRaw = function (data, enc) {
     ...
     * @returns {Boolean}
     */
    InvItem.prototype.isBlock = function () {
        switch (this.type) {
     ...
     * @returns {Boolean}
     */
    InvItem.prototype.isTX = function () {
        switch (this.type) {
     ...
     * @returns {Boolean}
     */
    InvItem.prototype.hasWitness = function () {
 ...
 * @const {Object}
 */
InvItem.typesByVal = (_a = {
        1: 'TX',
        2: 'BLOCK',
        3: 'FILTERED_BLOCK',
        4: 'CMPCT_BLOCK'
    },
    _a[1 | (1 << 30)] = 'WITNESS_TX',
    _a[2 | (1 << 30)] = 'WITNESS_BLOCK',
    _a[3 | (1 << 30)] = 'WITNESS_FILTERED_BLOCK',
    _a);
/**
