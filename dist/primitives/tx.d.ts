...
declare class TX {
     ...
     */
    signatureHash(index: number, prev: Script, value: SatoshiAmount, type: SighashType, version: number): Buffer;
    /**
     ...
     * @returns {Boolean}
     */
    checksig(index: number, prev: Script, value: SatoshiAmount, sig: Buffer, key: Buffer, version: number): boolean;
    /**
     ...
     */
    signature(index: number, prev: Script, value: SatoshiAmount, key: Buffer, type: SighashType, version: number): Buffer;
    /**
     ...
     */
    getFee(view: CoinView): SatoshiAmount;
    /**
     * Calculate the total input value.
     * @param {CoinView} view
     * @returns {SatoshiAmount} value
     */
    getInputValue(view: CoinView): SatoshiAmount;
    /**
     * Calculate the total output value.
     * @returns {SatoshiAmount} value
     */
    getOutputValue(): SatoshiAmount;
    /**
     ...
     */
    getMinFee(size: number | null, rate: Rate | null): SatoshiAmount;
    /**
     ...
     * @returns {SatoshiAmount} fee
     */
    getRoundFee(size: number | null, rate: Rate | null): SatoshiAmount;
    /**
     ...
     * @returns {TX}
     */
    fromReader(br: BufferReader, block: boolean): TX;
    /**
