...
export namespace testnet {
    ...
    namespace genesis {
        ...
        export const prevBlock: Buffer;
        export const merkleRoot: Buffer;
        const time_1: number;
        export { time_1 as time };
        export const bits: number;
        export const nonce: number;
    ...
    namespace block {
        ...
        const bip34hash: Buffer;
        const bip65height: number;
        const bip65hash: Buffer;
        const bip66height: number;
        const bip66hash: Buffer;
...
export namespace simnet {
    ...
    export namespace txnData_2 {
        const time_4: number;
        export { time_4 as time };
        const count_2: number;
        export { count_2 as count };
        const rate_2: number;
        export { rate_2 as rate };
    }
    export { txnData_2 as txnData };
