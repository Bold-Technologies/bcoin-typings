 ...
 * *
 */
export type opcodes = number;
export var opcodesByVal: {
    0: string;
    76: string;
    77: string;
    78: string;
...
export namespace flags {
    import MANDATORY_VERIFY_FLAGS = VERIFY_P2SH;
    export { MANDATORY_VERIFY_FLAGS };
    export const STANDARD_VERIFY_FLAGS: number;
    export const ONLY_STANDARD_VERIFY_FLAGS: number;
}
...
export namespace types {
    ...
    const WITNESSMALFORMED: number;
    const WITNESSSCRIPTHASH: number;
    const WITNESSPUBKEYHASH: number;
}
/**
 * Output script types.
 */
export type types = number;
export var typesByVal: {
    0: string;
    1: string;
    2: string;
    3: string;
...
export function isHashType(sig: Buffer): boolean;
export function isLowDER(sig: Buffer): boolean;
