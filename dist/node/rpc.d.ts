...
declare class RPC {
    ...
    getTXOutProof(args: any, help: any): Promise<string>;
    ...
    sendRawTransaction(args: any, help: any): Promise<Hash>;
    ...
    getDescriptorInfo(args: any, help: any): Promise<{
        descriptor: any;
        checksum: string;
        isrange: any;
        issolvable: any;
    ...
    deriveAddresses(args: any, help: any): Promise<any[]>;
    getDescriptorRangeParams(valid: any): {
        low: number;
        high: number;
    };
